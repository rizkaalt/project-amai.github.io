...
<a href="/anime?id=${anime.id}"> <h2>${anime.title}</h2> </a>
...
.then(data => {
    ...
    refererDiv.innerHTML = `<h2> Currently watching ${anime.title} Episode ${no}. You may use an adblock extension. </h2>  <iframe scrolling="no" frameBorder="0" allowfullscreen = "true" height="580" width="1000" src="${data.headers.Referer}" </iframe> <p></p>`
